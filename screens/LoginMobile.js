...
const LoginMobile = ({navigation}) => {
  ...
  return auth().signInWithCredential(googleCredential);
    ...
    return (
     ...
     <Text onPress={()=>{navigation.navigate('Login')}} style={styles.subHeading}><Text style={{color:'#AC849C', textDecorationLine: 'underline',  fontWeight: 'bold'}}>Click here</Text> if you already have an account</Text>
